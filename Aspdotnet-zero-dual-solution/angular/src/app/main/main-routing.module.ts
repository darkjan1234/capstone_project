        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    
                    {
                        ...
                        loadChildren: () => import('./maintenance/notifications/notification.module').then(m => m.NotificationModule),
                    ...
                    
                    {
                        ...
                        loadChildren: () => import('./maintenance/communicationHistories/communicationHistory.module').then(m => m.CommunicationHistoryModule),
                    ...
                    
                    {
                        ...
                        loadChildren: () => import('./maintenance/pttMessages/pttMessage.module').then(m => m.PTTMessageModule),
                    ...
                    
                    {
                        ...
                        loadChildren: () => import('./maintenance/groupMembers/groupMember.module').then(m => m.GroupMemberModule),
                    ...
                    
                    {
                        ...
                        loadChildren: () => import('./maintenance/pttUsers/pttUser.module').then(m => m.PttUserModule),
