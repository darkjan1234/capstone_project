...
@NgModule({
    providers: [
        ApiServiceProxies.PPOsServiceProxy,        
        ApiServiceProxies.LogsServiceProxy,        
        ApiServiceProxies.NotificationsServiceProxy,        
        ApiServiceProxies.CommunicationHistoriesServiceProxy,        
        ApiServiceProxies.PTTMessagesServiceProxy,        
        ApiServiceProxies.GroupMembersServiceProxy,        
        ApiServiceProxies.GroupsServiceProxy,        
        ApiServiceProxies.PttUsersServiceProxy,        
