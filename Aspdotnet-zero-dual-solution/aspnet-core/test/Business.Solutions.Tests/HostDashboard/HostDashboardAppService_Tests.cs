...
using Business.Solutions.MultiTenancy.HostDashboard;
...
namespace Business.Solutions.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(SolutionsDbContext context, SubscriptionPayment subscriptionPayment)
        {
