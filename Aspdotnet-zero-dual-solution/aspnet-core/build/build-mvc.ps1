...
$webMvcFolder = Join-Path $slnFolder "src/Business.Solutions.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/Business.Solutions.Web.Public"
...
dotnet restore Business.Solutions.Web.sln
