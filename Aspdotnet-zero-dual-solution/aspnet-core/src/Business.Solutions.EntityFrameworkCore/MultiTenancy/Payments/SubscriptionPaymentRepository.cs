...
{
    public class SubscriptionPaymentRepository : SolutionsRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<SolutionsDbContext> dbContextProvider)
