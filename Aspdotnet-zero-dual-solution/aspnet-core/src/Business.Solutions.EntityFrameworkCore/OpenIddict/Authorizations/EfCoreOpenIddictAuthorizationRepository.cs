...
namespace Business.Solutions.OpenIddict.Authorizations
{
    public class EfCoreOpenIddictAuthorizationRepository : SolutionsRepositoryBase<OpenIddictAuthorization, Guid>,
