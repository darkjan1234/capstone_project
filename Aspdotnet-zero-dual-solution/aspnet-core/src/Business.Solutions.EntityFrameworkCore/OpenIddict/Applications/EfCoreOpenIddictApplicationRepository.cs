...
namespace Business.Solutions.OpenIddict.Applications
{
    public class EfCoreOpenIddictApplicationRepository : SolutionsRepositoryBase<OpenIddictApplication, Guid>,
