namespace Business.Solutions.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_Logs_Delete = "Pages.Logs.Delete";
        ...
        public const string Pages_Notifications_Edit = "Pages.Notifications.Edit";
        public const string Pages_Notifications_Delete = "Pages.Notifications.Delete";

        public const string Pages_CommunicationHistories = "Pages.CommunicationHistories";
        public const string Pages_CommunicationHistories_Create = "Pages.CommunicationHistories.Create";
        public const string Pages_CommunicationHistories_Edit = "Pages.CommunicationHistories.Edit";
        public const string Pages_CommunicationHistories_Delete = "Pages.CommunicationHistories.Delete";

        public const string Pages_PTTMessages = "Pages.PTTMessages";
        public const string Pages_PTTMessages_Create = "Pages.PTTMessages.Create";
        public const string Pages_PTTMessages_Edit = "Pages.PTTMessages.Edit";
        public const string Pages_PTTMessages_Delete = "Pages.PTTMessages.Delete";
        ...
        public const string Pages_PttUsers = "Pages.PttUsers";
        public const string Pages_PttUsers_Create = "Pages.PttUsers.Create";
