...
/// </summary>
public class SolutionsSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public SolutionsSimplePermissionDependency()
    {
    ...
    public SolutionsSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public SolutionsSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
