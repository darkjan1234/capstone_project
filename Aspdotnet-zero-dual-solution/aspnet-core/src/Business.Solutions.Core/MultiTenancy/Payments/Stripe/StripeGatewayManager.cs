...
{
    public class StripeGatewayManager : SolutionsServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Solutions";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + SolutionsConsts.Currency;
        }
