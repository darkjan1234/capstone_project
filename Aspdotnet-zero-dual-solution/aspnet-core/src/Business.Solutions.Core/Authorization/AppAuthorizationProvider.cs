...
namespace Business.Solutions.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            logs.CreateChildPermission(AppPermissions.Pages_Logs_Delete, L("DeleteLog"));

            var notifications = pages.CreateChildPermission(AppPermissions.Pages_Notifications, L("Notifications"));
            notifications.CreateChildPermission(AppPermissions.Pages_Notifications_Create, L("CreateNewNotification"));
            notifications.CreateChildPermission(AppPermissions.Pages_Notifications_Edit, L("EditNotification"));
            notifications.CreateChildPermission(AppPermissions.Pages_Notifications_Delete, L("DeleteNotification"));

            var communicationHistories = pages.CreateChildPermission(AppPermissions.Pages_CommunicationHistories, L("CommunicationHistories"));
            communicationHistories.CreateChildPermission(AppPermissions.Pages_CommunicationHistories_Create, L("CreateNewCommunicationHistory"));
            communicationHistories.CreateChildPermission(AppPermissions.Pages_CommunicationHistories_Edit, L("EditCommunicationHistory"));
            communicationHistories.CreateChildPermission(AppPermissions.Pages_CommunicationHistories_Delete, L("DeleteCommunicationHistory"));

            var pttMessages = pages.CreateChildPermission(AppPermissions.Pages_PTTMessages, L("PTTMessages"));
            pttMessages.CreateChildPermission(AppPermissions.Pages_PTTMessages_Create, L("CreateNewPTTMessage"));
            pttMessages.CreateChildPermission(AppPermissions.Pages_PTTMessages_Edit, L("EditPTTMessage"));
            pttMessages.CreateChildPermission(AppPermissions.Pages_PTTMessages_Delete, L("DeletePTTMessage"));
            ...
            var groups = pages.CreateChildPermission(AppPermissions.Pages_Groups, L("Groups"));
            groups.CreateChildPermission(AppPermissions.Pages_Groups_Create, L("CreateNewGroup"));
            groups.CreateChildPermission(AppPermissions.Pages_Groups_Edit, L("EditGroup"));
            groups.CreateChildPermission(AppPermissions.Pages_Groups_Delete, L("DeleteGroup"));

            var pttUsers = pages.CreateChildPermission(AppPermissions.Pages_PttUsers, L("PttUsers"));
            pttUsers.CreateChildPermission(AppPermissions.Pages_PttUsers_Create, L("CreateNewPttUser"));
