...
using Business.Solutions.Authentication;
using Business.Solutions.DashboardCustomization;
...
namespace Business.Solutions.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!SolutionsConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        SolutionsConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        SolutionsDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        SolutionsDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = SolutionsDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{SolutionsDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{SolutionsDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = SolutionsDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = SolutionsDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    SolutionsDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = SolutionsDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{SolutionsDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{SolutionsDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = SolutionsDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = SolutionsDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    SolutionsDashboardCustomizationConsts.Widgets.Tenant
