...
namespace Business.Solutions.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : SolutionsServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Business.Solutions", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
