...
using Business.Solutions.Authorization.Ldap;
...
using Business.Solutions.DynamicEntityProperties;
...
using Business.Solutions.WebHooks;
using Newtonsoft.Json;

namespace Business.Solutions
{
    [DependsOn(
        typeof(SolutionsCoreSharedModule),
    ...
    public class SolutionsCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, SolutionsMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<SolutionsSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
