...
using Business.Solutions.Core.Base;
using Business.Solutions.Core.Extensions;
using Business.Solutions.Dto;
using Business.Solutions.Types;

namespace Business.Solutions.Queries
{
    public class OrganizationUnitQuery : SolutionsQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
