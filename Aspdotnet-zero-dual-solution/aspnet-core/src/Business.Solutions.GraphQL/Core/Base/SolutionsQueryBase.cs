...
namespace Business.Solutions.Core.Base
{
    public abstract class SolutionsQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected SolutionsQueryBase(string fieldName,
