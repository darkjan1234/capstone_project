...
using Business.Solutions.Web.OpenIddict.Claims;
using Business.Solutions.Web.OpenIddict.ViewModels.Authorize;
using OpenIddict.Abstractions;
using OpenIddict.Server.AspNetCore;

namespace Business.Solutions.Web.OpenIddict.Controllers
{
