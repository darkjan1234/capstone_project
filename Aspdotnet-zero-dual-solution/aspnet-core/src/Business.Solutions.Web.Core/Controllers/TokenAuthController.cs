...
using Business.Solutions.Authentication.TwoFactor;
using Business.Solutions.Authentication.TwoFactor.Google;
...
using Business.Solutions.Web.Authentication.JwtBearer;
using Business.Solutions.Web.Authentication.TwoFactor;
using Business.Solutions.Web.Models.TokenAuth;
using Business.Solutions.Authorization.Impersonation;
using Business.Solutions.Authorization.Roles;
using Business.Solutions.Configuration;
using Business.Solutions.Identity;
using Business.Solutions.Net.Sms;
using Business.Solutions.Notifications;
using Business.Solutions.Security.Recaptcha;
using Business.Solutions.Web.Authentication.External;
...
namespace Business.Solutions.Web.Controllers
{
    ...
    public class TokenAuthController : SolutionsControllerBase
    {
        ...
        private async Task<string> EncryptQueryParameters(long userId, Tenant tenant, string passwordResetCode)
        {
            ...
            var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                .ToString(SolutionsConsts.DateTimeOffsetFormat));
