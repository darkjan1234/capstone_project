...
{
    public class SolutionsAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public SolutionsAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
