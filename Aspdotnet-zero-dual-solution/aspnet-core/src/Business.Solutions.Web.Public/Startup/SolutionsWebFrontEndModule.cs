...
namespace Business.Solutions.Web.Public.Startup
{
    [DependsOn(
        typeof(SolutionsWebCoreModule)
    )]
    public class SolutionsWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public SolutionsWebFrontEndModule(IWebHostEnvironment env, SolutionsEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SolutionsWebFrontEndModule).GetAssembly());
        }
    }
}
