...
using Business.Solutions.Web.Public.Startup;
using Business.Solutions.Web.Session;
using Business.Solutions.Web.UiCustomization;

namespace Business.Solutions.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : SolutionsViewComponent
    {
