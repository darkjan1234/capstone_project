...
using Business.Solutions.DashboardCustomization.Definitions;
using Business.Solutions.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace Business.Solutions.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : SolutionsAppServiceBase, IDashboardCustomizationAppService
    {
