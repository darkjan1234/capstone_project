...
using MiniExcelLibs;
using Business.Solutions.Authorization.Permissions;
...
using Business.Solutions.Authorization.Users.Exporting;
using Business.Solutions.Dto;
using Business.Solutions.Net.Emailing;
...
namespace Business.Solutions.Authorization.Users
{
    ...
    public class UserAppService : SolutionsAppServiceBase, IUserAppService
    {
