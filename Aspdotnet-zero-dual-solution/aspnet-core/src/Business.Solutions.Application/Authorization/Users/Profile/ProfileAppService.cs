...
using Business.Solutions.Authorization.Users.Profile.Cache;
...
using Business.Solutions.Gdpr;
using Business.Solutions.Net.Sms;
using Business.Solutions.Security;
using Business.Solutions.Storage;
using Business.Solutions.Timing;
using Business.Solutions.Url;

namespace Business.Solutions.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : SolutionsAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Business.Solutions",
