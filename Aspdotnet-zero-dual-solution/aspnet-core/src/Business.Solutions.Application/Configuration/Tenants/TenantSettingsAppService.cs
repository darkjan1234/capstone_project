...
using Business.Solutions.Configuration.Tenants.Dto;
using Business.Solutions.Security;
using Business.Solutions.Storage;
using Business.Solutions.Timing;

namespace Business.Solutions.Configuration.Tenants
{
    ...
    public class TenantSettingsAppService : SettingsAppServiceBase, ITenantSettingsAppService
    {
        ...
        {
            if (_multiTenancyConfig.IsEnabled && !SolutionsConsts.AllowTenantsToChangeEmailSettings)
            {
                return;
            }
