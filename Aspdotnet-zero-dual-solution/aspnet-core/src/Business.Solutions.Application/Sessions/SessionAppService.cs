...
using Business.Solutions.Features;
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = SolutionsConsts.Currency,
                        CurrencySign = SolutionsConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = SolutionsConsts.AllowTenantsToChangeEmailSettings,
