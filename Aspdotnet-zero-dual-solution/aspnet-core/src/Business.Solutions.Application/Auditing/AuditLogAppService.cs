...
using Business.Solutions.Auditing.Exporting;
...
using EntityHistoryHelper = Business.Solutions.EntityHistory.EntityHistoryHelper;

namespace Business.Solutions.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : SolutionsAppServiceBase, IAuditLogAppService
    {
