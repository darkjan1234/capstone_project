...
using Business.Solutions.Migrations.Seed.Host;
...
namespace Business.Solutions.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : SolutionsAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<SolutionsDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{SolutionsConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{SolutionsConsts.ConnectionStringName}", constring);
        }
