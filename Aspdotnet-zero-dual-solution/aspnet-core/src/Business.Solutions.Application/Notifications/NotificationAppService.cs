...
using Business.Solutions.Organizations;

namespace Business.Solutions.Notifications
{
    [AbpAuthorize]
    public class NotificationAppService : SolutionsAppServiceBase, INotificationAppService
    {
