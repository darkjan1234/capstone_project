...
using Business.Solutions.DynamicEntityPropertyValues.Dto;
...
namespace Business.Solutions.DynamicEntityProperties
{
    ...
    public class DynamicEntityPropertyValueAppService : SolutionsAppServiceBase, IDynamicEntityPropertyValueAppService
    {
