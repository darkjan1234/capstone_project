...
using Business.Solutions.Mobile.MAUI.Services.Tenants;
using Business.Solutions.Mobile.MAUI.Helpers;

#if ANDROID
using Business.Solutions.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace Business.Solutions.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new Business.Solutions.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
